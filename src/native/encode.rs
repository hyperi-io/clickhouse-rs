...
/// bodies (layer 05c) or onto a TCP socket (future layer 05b) match
...
pub fn encode_columns(
    ...
    // buffers (no copy, no per-cell allocation). For 1M rows × N
    // columns this avoids 1M × N heap allocations versus the
